...
import 'p8excluirresponsabilidade_model.dart';
export 'p8excluirresponsabilidade_model.dart';

class P8excluirresponsabilidadeWidget extends StatefulWidget {
  const P8excluirresponsabilidadeWidget({super.key});

  @override
  State<P8excluirresponsabilidadeWidget> createState() =>
      _P8excluirresponsabilidadeWidgetState();
}

class _P8excluirresponsabilidadeWidgetState
    extends State<P8excluirresponsabilidadeWidget>
    with TickerProviderStateMixin {
  late P8excluirresponsabilidadeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8excluirresponsabilidadeModel());
      ...
      appBar: AppBar(
        ...
        title: Text(
          FFLocalizations.of(context).getText(
            '8b3u4buv' /* Excluir Responsabilidade */,
          ),
                          ...
                          child: Align(
                            ...
                            child: Padding(
                              ...
                              child: FFButtonWidget(
                                onPressed: () async {
                                  context
                                      .pushNamed('p8centralresponsabilidades');
                                },

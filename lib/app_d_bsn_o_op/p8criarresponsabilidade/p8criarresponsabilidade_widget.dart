...
import 'p8criarresponsabilidade_model.dart';
export 'p8criarresponsabilidade_model.dart';

class P8criarresponsabilidadeWidget extends StatefulWidget {
  const P8criarresponsabilidadeWidget({super.key});

  @override
  State<P8criarresponsabilidadeWidget> createState() =>
      _P8criarresponsabilidadeWidgetState();
}

class _P8criarresponsabilidadeWidgetState
    extends State<P8criarresponsabilidadeWidget> with TickerProviderStateMixin {
  late P8criarresponsabilidadeModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8criarresponsabilidadeModel());
      ...
      appBar: AppBar(
        ...
        title: Text(
          FFLocalizations.of(context).getText(
            'qov3iyf7' /* Criar Responsabilidade */,
          ),

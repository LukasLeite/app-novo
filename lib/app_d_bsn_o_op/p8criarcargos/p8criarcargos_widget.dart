...
import 'p8criarcargos_model.dart';
export 'p8criarcargos_model.dart';

class P8criarcargosWidget extends StatefulWidget {
  const P8criarcargosWidget({super.key});

  @override
  State<P8criarcargosWidget> createState() => _P8criarcargosWidgetState();
}

class _P8criarcargosWidgetState extends State<P8criarcargosWidget>
    with TickerProviderStateMixin {
  late P8criarcargosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8criarcargosModel());
    ...
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        leading: FlutterFlowIconButton(
          ...
          onPressed: () async {
            context.pushNamed('menuPrincipall');
          },
        ),
        title: Align(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: FFLocalizations.of(context).getText(
                          'cttomfmy' /* Digite o nome do cargo */,
                        ),
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: FFLocalizations.of(context).getText(
                          '3px7e7ii' /* Digite o ID do funcionário */,
                        ),
                        hintStyle: FlutterFlowTheme.of(context)
                            .bodySmall
                            .override(
                  ...
                  Padding(
                    ...
                    child: TextFormField(
                      ...
                      decoration: InputDecoration(
                        ...
                        hintText: FFLocalizations.of(context).getText(
                          'q83glqw4' /* Digite o ID do autorizador */,
                        ),
                        hintStyle: FlutterFlowTheme.of(context)
                            .bodySmall
                            .override(
                    ...
                    child: Align(
                      ...
                      child: Padding(
                        ...
                        child: FFButtonWidget(
                          onPressed: () async {
                            context.pushNamed('p8centraldecargos');
                          },
                    ...
                    child: SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'cckr3czl' /* Digite o nome do cargo */,
                          ),
                          hintStyle: FlutterFlowTheme.of(context)
                              .bodySmall
                              .override(
                    ...
                    child: SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'zxpr985s' /* Digite o ID do funcionário */,
                          ),
                          hintStyle: FlutterFlowTheme.of(context)
                              .bodySmall
                              .override(
                    ...
                    child: SizedBox(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'piojwi4o' /* Digite o ID do autorizador */,
                          ),
                          hintStyle: FlutterFlowTheme.of(context)
                              .bodySmall
                              .override(

...
import 'p8solicitarvenda_model.dart';
export 'p8solicitarvenda_model.dart';

class P8solicitarvendaWidget extends StatefulWidget {
  const P8solicitarvendaWidget({super.key});

  @override
  State<P8solicitarvendaWidget> createState() => _P8solicitarvendaWidgetState();
}

class _P8solicitarvendaWidgetState extends State<P8solicitarvendaWidget>
    with TickerProviderStateMixin {
  late P8solicitarvendaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8solicitarvendaModel());
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'fe34v8e2' /* Digite quantas horas quer vend... */,
                          ),
                          hintStyle: FlutterFlowTheme.of(context)
                              .bodySmall
                              .override(
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'bfyoycu6' /* Digite o ID do autorizante */,
                          ),
                          hintStyle: FlutterFlowTheme.of(context)
                              .bodySmall
                              .override(
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              'v9buetmc' /* Digite quantas horas quer vend... */,
                            ),
                            hintStyle: FlutterFlowTheme.of(context)
                                .bodySmall
                                .override(
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              '3yiuwuoo' /* Digite o ID do autorizante */,
                            ),
                            hintStyle: FlutterFlowTheme.of(context)
                                .bodySmall
                                .override(

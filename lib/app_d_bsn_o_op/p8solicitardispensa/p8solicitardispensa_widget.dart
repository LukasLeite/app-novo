...
import 'p8solicitardispensa_model.dart';
export 'p8solicitardispensa_model.dart';

class P8solicitardispensaWidget extends StatefulWidget {
  const P8solicitardispensaWidget({super.key});

  @override
  State<P8solicitardispensaWidget> createState() =>
      _P8solicitardispensaWidgetState();
}

class _P8solicitardispensaWidgetState extends State<P8solicitardispensaWidget>
    with TickerProviderStateMixin {
  late P8solicitardispensaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8solicitardispensaModel());
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            '47tndnj8' /* Digite o ID do autorizante */,
                          ),
                          hintStyle: FlutterFlowTheme.of(context)
                              .bodySmall
                              .override(
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              'g9di8a9h' /* Digite o ID do autorizante */,
                            ),
                            hintStyle: FlutterFlowTheme.of(context)
                                .bodySmall
                                .override(

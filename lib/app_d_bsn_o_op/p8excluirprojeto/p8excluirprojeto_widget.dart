...
import 'p8excluirprojeto_model.dart';
export 'p8excluirprojeto_model.dart';

class P8excluirprojetoWidget extends StatefulWidget {
  const P8excluirprojetoWidget({super.key});

  @override
  State<P8excluirprojetoWidget> createState() => _P8excluirprojetoWidgetState();
}

class _P8excluirprojetoWidgetState extends State<P8excluirprojetoWidget>
    with TickerProviderStateMixin {
  late P8excluirprojetoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8excluirprojetoModel());
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'f0x6gnak' /* Digite o nome do projeto */,
                          ),
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              'ekqp3p7t' /* Digite o nome do projeto */,
                            ),
                            hintStyle: FlutterFlowTheme.of(context)
                                .bodySmall
                                .override(

...
import 'p8excluircargos_model.dart';
export 'p8excluircargos_model.dart';

class P8excluircargosWidget extends StatefulWidget {
  const P8excluircargosWidget({super.key});

  @override
  State<P8excluircargosWidget> createState() => _P8excluircargosWidgetState();
}

class _P8excluircargosWidgetState extends State<P8excluircargosWidget>
    with TickerProviderStateMixin {
  late P8excluircargosModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8excluircargosModel());
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'zkv415vj' /* Digite o nome do cargo */,
                          ),
                    ...
                    Padding(
                      ...
                      child: TextFormField(
                        ...
                        decoration: InputDecoration(
                          ...
                          hintText: FFLocalizations.of(context).getText(
                            'ochv5z52' /* Digite o ID do funcionário */,
                          ),
                          hintStyle: FlutterFlowTheme.of(context)
                              .bodySmall
                              .override(
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'jpf1c71g' /* Digite o nome do cargo */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(
                        ...
                        child: SizedBox(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                '3yc6z0n7' /* Digite o ID do funcionário */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(

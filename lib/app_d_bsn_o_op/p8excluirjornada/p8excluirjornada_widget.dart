...
import 'p8excluirjornada_model.dart';
export 'p8excluirjornada_model.dart';

class P8excluirjornadaWidget extends StatefulWidget {
  const P8excluirjornadaWidget({super.key});

  @override
  State<P8excluirjornadaWidget> createState() => _P8excluirjornadaWidgetState();
}

class _P8excluirjornadaWidgetState extends State<P8excluirjornadaWidget>
    with TickerProviderStateMixin {
  late P8excluirjornadaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8excluirjornadaModel());
                        ...
                        child: TextFormField(
                          ...
                          decoration: InputDecoration(
                            ...
                            hintText: FFLocalizations.of(context).getText(
                              '14k1jj0q' /* Digite o nome a Jornada */,
                            ),
                        ...
                        Padding(
                          ...
                          child: TextFormField(
                            ...
                            decoration: InputDecoration(
                              ...
                              hintText: FFLocalizations.of(context).getText(
                                'h59glnx4' /* Digite o nome a Jornada */,
                              ),
                              hintStyle: FlutterFlowTheme.of(context)
                                  .bodySmall
                                  .override(

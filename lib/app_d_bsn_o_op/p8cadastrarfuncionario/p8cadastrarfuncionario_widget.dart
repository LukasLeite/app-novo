...
import 'p8cadastrarfuncionario_model.dart';
export 'p8cadastrarfuncionario_model.dart';

class P8cadastrarfuncionarioWidget extends StatefulWidget {
  const P8cadastrarfuncionarioWidget({super.key});

  @override
  State<P8cadastrarfuncionarioWidget> createState() =>
      _P8cadastrarfuncionarioWidgetState();
}

class _P8cadastrarfuncionarioWidgetState
    extends State<P8cadastrarfuncionarioWidget> with TickerProviderStateMixin {
  late P8cadastrarfuncionarioModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8cadastrarfuncionarioModel());
        ...
        title: Align(
          ...
          child: Text(
            FFLocalizations.of(context).getText(
              '7xmbta3y' /* Cadastro de Funcionários */,
            ),
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'cff9i2kg' /* Digite o nome do fúncionario */,
                                  ),
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    '1yaxr3yl' /* Digite um e-mail válido */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'mewftww3' /* Digite o cliente associado */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'ozdtgfyu' /* Digite o nome do fúncionario */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      '3qb4e24v' /* Digite um e-mail válido */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'ag5p465y' /* Digite o cliente associado */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(

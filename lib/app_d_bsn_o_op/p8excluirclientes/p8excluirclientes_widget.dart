...
import 'p8excluirclientes_model.dart';
export 'p8excluirclientes_model.dart';

class P8excluirclientesWidget extends StatefulWidget {
  const P8excluirclientesWidget({super.key});

  @override
  State<P8excluirclientesWidget> createState() =>
      _P8excluirclientesWidgetState();
}

class _P8excluirclientesWidgetState extends State<P8excluirclientesWidget>
    with TickerProviderStateMixin {
  late P8excluirclientesModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8excluirclientesModel());
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  'zlqn4u0d' /* Digite o nome fantasia */,
                                ),
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  '4a6g83a7' /* Digite a razão social */,
                                ),
                                hintStyle: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                          ...
                          Padding(
                            ...
                            child: TextFormField(
                              ...
                              decoration: InputDecoration(
                                ...
                                hintText: FFLocalizations.of(context).getText(
                                  'moldj4dv' /* Digite o ID do sistema externo */,
                                ),
                                hintStyle: FlutterFlowTheme.of(context)
                                    .bodySmall
                                    .override(
                            ...
                            child: Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context.pushNamed('p8centraldeclientes');
                                  },
                            ...
                            child: SizedBox(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'q3yrlv56' /* Digite o nome fantasia */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                            ...
                            child: SizedBox(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    '47k3pj2k' /* Digite a razão social */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                            ...
                            child: SizedBox(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    '70ma9ztx' /* Digite o ID do sistema externo */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(

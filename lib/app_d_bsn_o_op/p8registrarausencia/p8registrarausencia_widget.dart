...
import 'p8registrarausencia_model.dart';
export 'p8registrarausencia_model.dart';

class P8registrarausenciaWidget extends StatefulWidget {
  const P8registrarausenciaWidget({super.key});

  @override
  State<P8registrarausenciaWidget> createState() =>
      _P8registrarausenciaWidgetState();
}

class _P8registrarausenciaWidgetState extends State<P8registrarausenciaWidget>
    with TickerProviderStateMixin {
  late P8registrarausenciaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8registrarausenciaModel());
    ...
    _model.emailAddressTextController9 ??= TextEditingController();
    _model.emailAddressFocusNode9 ??= FocusNode();

    _model.emailAddressTextController10 ??= TextEditingController();
    _model.emailAddressFocusNode10 ??= FocusNode();

    _model.emailAddressTextController11 ??= TextEditingController();
    _model.emailAddressFocusNode11 ??= FocusNode();

    _model.emailAddressTextController12 ??= TextEditingController();
    _model.emailAddressFocusNode12 ??= FocusNode();

    _model.emailAddressTextController13 ??= TextEditingController();
    _model.emailAddressFocusNode13 ??= FocusNode();

    _model.emailAddressTextController14 ??= TextEditingController();
      ...
      appBar: AppBar(
        ...
        title: Text(
          FFLocalizations.of(context).getText(
            'm0fv6vtt' /* Registro de Ausências */,
          ),
                    ...
                    child: Container(
                      ...
                      child: Padding(
                        ...
                        child: InkWell(
                          ...
                          onTap: () async {
                            context.pushNamed('p8centraldeausencias');
                          },
                          child: Column(
                            mainAxisSize: MainAxisSize.max,
                            ...
                            children: [
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      '3rqs6tsm' /* Digite o ID do colaborador */,
                                    ),
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'sa95wpww' /* Digite o ID do Autorizante */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                              ...
                              Padding(
                                ...
                                child: TextFormField(
                                  controller:
                                      _model.emailAddressTextController7,
                            ...
                            children: [
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.emailAddressTextController8,
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        '4czu8qzw' /* Digite o ID do colaborador */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
                                    ...
                                    keyboardType: TextInputType.emailAddress,
                                    validator: _model
                                        .emailAddressTextController8Validator
                                        .asValidator(context),
                                  ),
                                ).animateOnPageLoad(animationsMap[
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.emailAddressTextController9,
                                    ...
                                    decoration: InputDecoration(
                                      ...
                                      hintText:
                                          FFLocalizations.of(context).getText(
                                        'a195jsq0' /* Digite o ID do Autorizante */,
                                      ),
                                      hintStyle: FlutterFlowTheme.of(context)
                                          .bodySmall
                                          .override(
                                    ...
                                    keyboardType: TextInputType.emailAddress,
                                    validator: _model
                                        .emailAddressTextController9Validator
                                        .asValidator(context),
                                  ),
                                ).animateOnPageLoad(animationsMap[
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.emailAddressTextController10,
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.emailAddressTextController11,
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.emailAddressTextController12,
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.emailAddressTextController13,
                              ...
                              Padding(
                                ...
                                child: SizedBox(
                                  ...
                                  child: TextFormField(
                                    controller:
                                        _model.emailAddressTextController14,

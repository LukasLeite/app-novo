...
import 'p8comprovantedeponto_model.dart';
export 'p8comprovantedeponto_model.dart';

class P8comprovantedepontoWidget extends StatefulWidget {
  const P8comprovantedepontoWidget({super.key});

  @override
  State<P8comprovantedepontoWidget> createState() =>
      _P8comprovantedepontoWidgetState();
}

class _P8comprovantedepontoWidgetState extends State<P8comprovantedepontoWidget>
    with TickerProviderStateMixin {
  late P8comprovantedepontoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8comprovantedepontoModel());
            ...
            child: SingleChildScrollView(
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(20.0, 30.0, 0.0, 10.0),
                    child: SingleChildScrollView(

...
import 'p8excluircolaboradores_model.dart';
export 'p8excluircolaboradores_model.dart';

class P8excluircolaboradoresWidget extends StatefulWidget {
  const P8excluircolaboradoresWidget({super.key});

  @override
  State<P8excluircolaboradoresWidget> createState() =>
      _P8excluircolaboradoresWidgetState();
}

class _P8excluircolaboradoresWidgetState
    extends State<P8excluircolaboradoresWidget> with TickerProviderStateMixin {
  late P8excluircolaboradoresModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8excluircolaboradoresModel());
        ...
        title: Align(
          ...
          child: Text(
            FFLocalizations.of(context).getText(
              'd6ywl3wu' /* Excluir Colaboradores */,
            ),
                            ...
                            child: Align(
                              ...
                              child: Padding(
                                ...
                                child: FFButtonWidget(
                                  onPressed: () async {
                                    context
                                        .pushNamed('p8centraldecolaboradores');
                                  },

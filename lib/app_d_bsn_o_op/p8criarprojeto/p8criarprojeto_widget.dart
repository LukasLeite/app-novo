...
import 'p8criarprojeto_model.dart';
export 'p8criarprojeto_model.dart';

class P8criarprojetoWidget extends StatefulWidget {
  const P8criarprojetoWidget({super.key});

  @override
  State<P8criarprojetoWidget> createState() => _P8criarprojetoWidgetState();
}

class _P8criarprojetoWidgetState extends State<P8criarprojetoWidget>
    with TickerProviderStateMixin {
  late P8criarprojetoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8criarprojetoModel());
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'zvxdpe69' /* Digite o ID do cliente */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                              ...
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed('p8centraldeprojetos');
                                    },
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      '06jmf1bq' /* Digite o ID do cliente */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(

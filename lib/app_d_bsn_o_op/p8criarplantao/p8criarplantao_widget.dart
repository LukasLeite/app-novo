...
import 'p8criarplantao_model.dart';
export 'p8criarplantao_model.dart';

class P8criarplantaoWidget extends StatefulWidget {
  const P8criarplantaoWidget({super.key});

  @override
  State<P8criarplantaoWidget> createState() => _P8criarplantaoWidgetState();
}

class _P8criarplantaoWidgetState extends State<P8criarplantaoWidget>
    with TickerProviderStateMixin {
  late P8criarplantaoModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8criarplantaoModel());
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'w0d5szti' /* Pontual ou recorrente? */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                            ...
                            Padding(
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'g3j0u74w' /* Digite as horas do plantão */,
                                  ),
                                  hintStyle: FlutterFlowTheme.of(context)
                                      .bodySmall
                                      .override(
                              ...
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed('p8centralplantoes');
                                    },
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      'ooa064tu' /* Pontual ou recorrente? */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      '3qo6y48e' /* Digite as horas do plantão */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(

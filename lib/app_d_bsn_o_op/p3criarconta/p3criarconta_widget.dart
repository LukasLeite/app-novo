...
import 'p3criarconta_model.dart';
export 'p3criarconta_model.dart';

class P3criarcontaWidget extends StatefulWidget {
  const P3criarcontaWidget({super.key});

  @override
  State<P3criarcontaWidget> createState() => _P3criarcontaWidgetState();
}

class _P3criarcontaWidgetState extends State<P3criarcontaWidget>
    with TickerProviderStateMixin {
  late P3criarcontaModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P3criarcontaModel());
                              ...
                              child: TextFormField(
                                ...
                                decoration: InputDecoration(
                                  ...
                                  hintText: FFLocalizations.of(context).getText(
                                    'b0x4qb6o' /* Digite um e-mail válido */,
                                  ),
                              ...
                              child: SizedBox(
                                ...
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    hintText:
                                        FFLocalizations.of(context).getText(
                                      '7z9p7vnh' /* Digite um e-mail válido */,
                                    ),
                                    hintStyle: FlutterFlowTheme.of(context)
                                        .bodySmall
                                        .override(

...
import 'p8criarjornadas_model.dart';
export 'p8criarjornadas_model.dart';

class P8criarjornadasWidget extends StatefulWidget {
  const P8criarjornadasWidget({super.key});

  @override
  State<P8criarjornadasWidget> createState() => _P8criarjornadasWidgetState();
}

class _P8criarjornadasWidgetState extends State<P8criarjornadasWidget>
    with TickerProviderStateMixin {
  late P8criarjornadasModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => P8criarjornadasModel());
                              ...
                              child: Align(
                                ...
                                child: Padding(
                                  ...
                                  child: FFButtonWidget(
                                    onPressed: () async {
                                      context.pushNamed('p8centraldejornadas');
                                    },
